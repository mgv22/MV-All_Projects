---
title: "Venit Modeling Assignment 4"
...
data.wine <- as.data.table(read.csv("~/Desktop/Graduate School/Supervised Learning/Module 10/wine.csv", head = TRUE, sep = ","))
data.wine$INDEX<- NULL
...
getDistribution(data.wine, data.wine$Norm_FreeSulfurDioxide, 'Free-Sulfur Dioxide')
